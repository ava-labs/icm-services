...
One special validator set is used to initialize this contract: The primary network validator set which is current at the time of contract instantiation. This will be used as the _root of trust_ as discussed in the [overview](summary.md).
