...
func TestInfoAPI_QueryParamsForwarding(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Create InfoAPI client with query params
...
func TestInfoAPI_HTTPHeadersForwarding(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Create InfoAPI client with headers
			apiConfig := &config.APIConfig{
				BaseURL:     server.URL,
...
func TestInfoAPI_MultipleMethodsWithParams(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		// Track which method is being called and capture params
	...
	// Verify query params were forwarded for each call
