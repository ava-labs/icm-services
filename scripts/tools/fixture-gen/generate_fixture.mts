...
// Ethereum Sepolia beacon chain genesis time
...
async function main() {
  ...
  console.log("=== Step 4: Fetching anchor beacon state (~270MB) ===");
  ...
  console.log("=== Step 5: Fetching target beacon state (another ~270MB) ===");
