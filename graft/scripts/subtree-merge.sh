...
# Example: subtree-merge.sh github.com/ava-labs/icm-contracts
# Example: subtree-merge.sh github.com/ava-labs/icm-contracts 1a498175
# Example: subtree-merge.sh github.com/ava-labs/icm-contracts main evm
#
# Arguments:
#   module-path: The Go module path (e.g., github.com/ava-labs/icm-contracts)
...
if [ $# -lt 1 ] || [ $# -gt 3 ]; then
  ...
  echo "Example: $0 github.com/ava-labs/icm-contracts" >&2
  echo "Example: $0 github.com/ava-labs/icm-contracts 1a498175" >&2
  echo "Example: $0 github.com/ava-labs/icm-contracts main icm-contracts" >&2
  exit 1
fi
...
if [ $# -eq 3 ]; then
  ...
  # Example: github.com/ava-labs/icm-contracts -> icm-contracts
