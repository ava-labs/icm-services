...
var _ = ginkgo.BeforeSuite(func(ctx context.Context) {
	...
	teleporterInfo = network.NewTeleporterTestInfo(localNetworkInstance)
...
var _ = ginkgo.Describe("[ICM Relayer & Signature Aggregator Integration Tests", func() {
	...
	ginkgo.It("DiffUpdaterReset",
		ginkgo.Label(servicesLabel),
		func(ctx context.Context) {
			servicesFlows.DiffUpdaterReset(ctx, log, localNetworkInstance, localEthereumNetworkInstance, teleporterInfo)
		})
